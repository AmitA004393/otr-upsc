    ...
    >
      ...
      >
        ...
        >
          ...
          <Box>
            <Typography>Select Mode for Login*</Typography>
            <ToggleButtonGroup
              color="primary"
              value={alignment}
              exclusive
            ...
            >
              ...
              <ToggleButton
                value="email"
                sx={{ width: "33%", border: "1px solid blue" }}
              >
                EMAIL
              </ToggleButton>
              <ToggleButton
          ...
          {alignment === "otr_id" && (
            <Box>
              <Box>
                {" "}
                <Typography sx={{ marginTop: "20px" }}>OTR ID*</Typography>
                <TextField
                  size="small"
                  sx={{ width: "100%" }}
                  placeholder="Please enter otr id"
                ></TextField>
              </Box>
              <Box>
                {" "}
                <Typography sx={{ marginTop: "20px" }}>Password*</Typography>
                <TextField
                  size="small"
                  sx={{ width: "100%" }}
          ...
          {alignment === "email" && (
            <Box>
              ...
              <Box>
                {" "}
                <Typography sx={{ marginTop: "20px" }}>Enter OTP*</Typography>
                <TextField
                  size="small"
                  sx={{
                    width: "75%",
